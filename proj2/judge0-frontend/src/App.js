...
import puzzles from "./data/chessPuzzles.json";
...
// Helper (unused now, but kept if you want later)
...
function App() {
  ...
  // NEW: mode + chess puzzle
  const [mode, setMode] = useState("code"); // "code" | "chess"
  ...
  const [sourceCode, setSourceCode] = useState(
    "print('Hello, Judge0!')  #Replace with your solution!"
  ); 
  ...
  const colors = {
    bg: "radial-gradient(1200px 800px at 10% -10%, #07212e 0%, #04111a 35%, #030b12 100%)",
    card:
      "linear-gradient(180deg, rgba(16,30,43,0.9) 0%, rgba(9,18,28,0.9) 100%)",
    border: "#1e2b3f",
    accent: "#00e0ff",
    accent2: "#00ffb3",
    text: "#d9f1ff",
    ...
    return (
      ...
      >
        ...
        <div style={{ fontSize: 14, opacity: 0.8, marginTop: 8 }}>
          Open this page from <b>My Orders → “Try a coding challenge”</b> so it
      ...
      >
        <button
          ...
          style={{
            ...
            background: mode === "code" ? "#041923" : "#07121a",
            color: colors.text,
            fontSize: 13,
            fontWeight: 600,
            cursor: "pointer",
          ...
          style={{
            ...
            border:
              mode === "chess"
                ...
                : `1px solid ${colors.border}`,
            background: mode === "chess" ? "#052015" : "#07121a",
            color: colors.text,
            fontSize: 13,
            fontWeight: 600,
            cursor: "pointer",
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  {
                    rewardMap[selectedProblem?.difficulty || "easy"]
                      .cashback
                  }
                </h3>
          ...
          >
            ...
            >
              ...
              {reward && (
                <div
                  style={{
                    marginTop: 16,
                    background:
                      "linear-gradient(90deg, rgba(0,255,179,0.1), rgba(0,224,255,0.1))",
                    padding: 14,
                    borderRadius: 12,
                    fontWeight: 700,
                    boxShadow:
                      "0 0 0 1px rgba(0,255,179,0.25) inset",
                    textAlign: "center",
                  }}
                >
                  {reward}
              ...
              >
                ...
                {selectedProblem?.testcases?.length ? (
                  <>
                    {selectedProblem?.testcases?.some(
                      (t) => t.unlocked
                    ) && (
                      <div
                        style={{
      ...
      {mode === "chess" && (
        ...
        >
          ...
          <div>
            ...
            >
              Solve tiny mate-in-1 / mate-in-2 puzzles as a break from
              coding.
            </p>
            <ul
              style={{
          ...
          <div>
            {selectedPuzzle && (
              <ChessPuzzle
                ...
                onSolved={(p) => {
                  console.log("Solved puzzle:", p.id);
                  // optional: call backend here if you want rewards
                }}
              />
            )}
          </div>
